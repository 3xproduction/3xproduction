...
//   • own            — купленные или заведённые с общего склада единицы
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 13, marginBottom: 14, maxWidth: 400, marginLeft: 'auto', marginRight: 'auto' }}>
        Сюда попадут купленные для проекта вещи, заведённое с общего склада, выданное со склада и одолженное у других проектов.
      </div>
